...
//            let messageMark = Message()
            ...
            _ = FriendsController.createMessageWithText(text: "You're fired", friend: donald, minutesAgo: 5, context: context)
            ...
            _ = FriendsController.createMessageWithText(text: "Please vote for me, you did for Billy!", friend: hillary, minutesAgo: 8 * 60 * 24, context: context)
...
//            messages = [messageMark, messageSteve]
    ...
    private func createSteveMessagesWithContext(context: NSManagedObjectContext) {
        ...
        _ = FriendsController.createMessageWithText(text: "Good morning..", friend: steve, minutesAgo: 3, context: context)
        _ = FriendsController.createMessageWithText(text: "Hello, how are you? Hope you are having a good morning!", friend: steve, minutesAgo: 2, context: context)
        ...
        _ = FriendsController.createMessageWithText(text: "Absolutely, I'll just use my gigantic iPhone 6 Plus until then!!!", friend: steve, minutesAgo: 1, context: context, isSender: true)
    }
