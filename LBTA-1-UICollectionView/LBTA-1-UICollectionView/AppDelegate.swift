...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        /* Can make the window the key window, and make it visible like below too,
         but using the convenience method makeKeyAndVisible() instead. */
//                window?.makeKey()
//                window?.isHidden = false
        ...
        // Need to set a rootViewController.
//        window?.rootViewController = ViewController()
//        window?.rootViewController = UINavigationController(ro otViewController: ViewController())
